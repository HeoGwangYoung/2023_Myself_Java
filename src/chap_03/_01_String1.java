...
public class _01_String1 {
    public static void main(String[] args) {
        ...
        System.out.println(s.indexOf("Java")); // 포함된 문자열이 시작되는 위치 7
        System.out.println(s.indexOf("C#")); // 포함되지 않으면 -1

        System.out.println(s.indexOf("and")); //처음 나오는 and 위치 12
        System.out.println(s.lastIndexOf("and")); //마지막에 나오는 and 위치 23
